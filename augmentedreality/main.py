...
def convert_to_png():
    try:
        ...
        clothes_try_on(output_path)

        return "Virtual try-on successful!"

    except Exception as e:
        return f"Error: {str(e)}", 500

def clothes_try_on(image_path):
    try:
